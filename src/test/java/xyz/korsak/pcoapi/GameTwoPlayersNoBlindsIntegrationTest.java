...
public class GameTwoPlayersNoBlindsIntegrationTest {
    ...
    @Autowired
    public GameTwoPlayersNoBlindsIntegrationTest(RedisTemplate<String, Room> redisTemplate) {
    ...
    public void setup() {
        ...
        File json = new File("src/test/resources/GameTwoPlayersNoBlindsIntegrationTest.json");
        try {
